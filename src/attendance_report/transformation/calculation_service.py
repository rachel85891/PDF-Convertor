...
from attendance_report.domain.models import AttendanceEntry, AttendanceReport, ReportTotals
...
class CalculationService:
    ...
    def _calculate_worked_hours(self, entry_time: str, exit_time: str, break_duration: str | None) -> Decimal:
    ...
    @staticmethod
    def _parse_break_minutes(value: str | None) -> int:
